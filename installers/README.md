...
`installers/modrinth/apko.yaml` builds a Wolfi image with the tools required by the Modrinth `.mrpack` installer script: `curl`, `jq`, `unzip`, BusyBox utilities, and CA certificates.
